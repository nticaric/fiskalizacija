...
namespace Nticaric\Fiskalizacija\Generators\PromijeniNacPlacZahtjev;
...
class PromijeniNacPlacZahtjevAType
{
    ...
    /**
     * @var \Nticaric\Fiskalizacija\Generators\RacunPNPType $racun
     */
    private $racun = null;
     ...
     * Gets as racun
     *
     * @return \Nticaric\Fiskalizacija\Generators\RacunPNPType
     */
     ...
     * Sets a new racun
     *
     * @param \Nticaric\Fiskalizacija\Generators\RacunPNPType $racun
     * @return self
     */
    public function setRacun(\Nticaric\Fiskalizacija\Generators\RacunPNPType $racun)
    {
        $this->racun = $racun;
        return $this;
    }
