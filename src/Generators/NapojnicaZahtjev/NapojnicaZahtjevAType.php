...
namespace Nticaric\Fiskalizacija\Generators\NapojnicaZahtjev;
...
class NapojnicaZahtjevAType
{
    ...
    /**
     * @var \Nticaric\Fiskalizacija\Generators\RacunNapojnicaType $racun
     */
    private $racun = null;
     ...
     * Gets as racun
     *
     * @return \Nticaric\Fiskalizacija\Generators\RacunNapojnicaType
     */
     ...
     * Sets a new racun
     *
     * @param \Nticaric\Fiskalizacija\Generators\RacunNapojnicaType $racun
     * @return self
     */
    public function setRacun(\Nticaric\Fiskalizacija\Generators\RacunNapojnicaType $racun)
    {
        $this->racun = $racun;
        return $this;
    }
